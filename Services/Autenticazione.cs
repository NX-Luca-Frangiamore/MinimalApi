...
namespace MinimalApi.Models
{
    ...
    {
        private AccessData db;
        public Autenticazione(Microsoft.Extensions.Options.IOptionsMonitor<AuthenticationSchemeOptions> options, ILoggerFactory logger, UrlEncoder encoder, ISystemClock clock, AccessData db) : base(options, logger, encoder, clock)
        {
            this.db = db;
        }
